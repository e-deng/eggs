  ...
  return (
    <div className="text-center py-16 px-4">
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-medium transition-colors mx-auto"
      >
